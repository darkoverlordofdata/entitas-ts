...
#
  run: (flags...) ->
    ...
    sb.push " *)"
    sb.push "[<AutoOpen>]"
    sb.push "module ComponentExtensions ="
    sb.push ""
    ...
    s1.push " *)"
    s1.push "[<AutoOpen>]"
    s1.push "module EntityExtensions ="
    s1.push ""
    s1.push "    open Entitas"
    s1.push "    open System"
    s1.push "    open System.Collections.Generic"
    s1.push ""
    s1.push "    let isNull x = match x with null -> true | _ -> false"
    s1.push "    let notNull x = match x with null -> false | _ -> true"
    s1.push ""
    ...
    s2.push " *)"
    s2.push "[<AutoOpen>]"
    s2.push "module MatcherExtensions ="
    s2.push ""
    s2.push "    open Entitas"
    s2.push "    open System"
    s2.push "    open System.Collections.Generic"
    s2.push ""
    ...
    s3.push " *)"
    s3.push "[<AutoOpen>]"
    s3.push "module WorldExtensions ="
    s3.push ""
    s3.push "    open Entitas"
    s3.push "    open System"
    s3.push "    open System.Collections.Generic"
    s3.push ""
    s3.push "    let isNull x = match x with null -> true | _ -> false"
    s3.push "    let notNull x = match x with null -> false | _ -> true"
    s3.push ""
    ...
    ###
    sb.push ""
    sb.push "    type Component with "
    kc = 0
    for Name, properties of config.components
      name = Name[0].toLowerCase()+Name[1...]
      sb.push "        static member #{Name} with get() = #{++kc}"    
    sb.push "        static member TotalComponents  with get() = #{++kc}"    
    sb.push ""
    ...
    for Name, properties of config.components
      ...
      switch properties
        when false
          ...
          s2.push "            with get() = Matcher.AllOf(Component.#{Name}) "
          s2.push ""
    ...
    fs.writeFileSync(path.join(process.cwd(), config.output.fsharp, 
      "Extensions/ComponentExtensions.fs"), sb.join('\n'))
