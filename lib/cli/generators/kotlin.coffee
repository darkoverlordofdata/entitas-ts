...
#
  run: (flags...) ->
    ...
    s0.push " */"
    s0.push ""
    s0.push "import com.darkoverlordofdata.entitas.ecs.IComponent"
    s0.push ""
    ...
    s1.push "import com.darkoverlordofdata.entitas.ecs.Entity"
    s1.push ""
    ...
    s2.push " */"
    s2.push ""
    s2.push "import com.darkoverlordofdata.entitas.ecs.Matcher"
    s2.push "import com.darkoverlordofdata.entitas.ecs.IMatcher"
    s2.push ""
    ...
    s3.push " */"
    s3.push ""
    s3.push "import com.darkoverlordofdata.entitas.ecs.Pool"
    s3.push "import com.darkoverlordofdata.entitas.ecs.Entity"
    s3.push "import com.darkoverlordofdata.entitas.ecs.Matcher"
    s3.push ""
    ...
    for Name, type of config.entities
        ...
        if config.components[Name] is false
            ...
            s3.push "    get() = getGroup(Matcher.#{Name})?.getSingleEntity()"
            s3.push ""
