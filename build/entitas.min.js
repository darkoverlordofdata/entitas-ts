...
(entitas={}));var entitas;
(function(entitas){var browser;(function(browser){var Systems=entitas.Systems;var VisualDebugging=function(){function VisualDebugging(){}VisualDebugging.init=function(pool){if(window["dat"]){browser.gui=new dat.GUI({height:5*32-1,width:300});VisualDebugging._controllers=[];var observer=new PoolObserver(pool);VisualDebugging._entities=browser.gui.addFolder("Entities");VisualDebugging._pools=browser.gui.addFolder("Pools");VisualDebugging._systems=browser.gui.addFolder("Systems");VisualDebugging._pools.add(observer,
"entities").listen();VisualDebugging._pools.add(observer,"reusable").listen();pool.onEntityCreated.add(function(pool,entity){var proxy=new EntityBehavior(entity);VisualDebugging._controllers[entity.creationIndex]=VisualDebugging._entities.add(proxy,proxy.name).listen()});pool.onEntityDestroyed.add(function(pool,entity){var controller=VisualDebugging._controllers[entity.creationIndex];delete VisualDebugging._controllers[entity.creationIndex];VisualDebugging._entities.remove(controller)});Systems.prototype.initialize=
function(){for(var i=0,initializeSysCount=this._initializeSystems.length;i<initializeSysCount;i++)this._initializeSystems[i].initialize();var sys=new SystemObserver(this);VisualDebugging._systems.add(sys,"initialize").listen();VisualDebugging._systems.add(sys,"execute").listen()};function get_Systems(){return"Systems "+" ("+this._initializeSystems.length+" init, "+this._executeSystems.length+" exe "}Object.defineProperty(Systems.prototype,"name",{get:function(){return"Systems"}});Object.defineProperty(Systems.prototype,
"Systems",{get:get_Systems})}};return VisualDebugging}();browser.VisualDebugging=VisualDebugging;var EntityBehavior=function(){function EntityBehavior(obj){var _this=this;this.obj=obj;if(this.obj.name)this._name=this.obj.name;else this._name="Entity_"+this.obj._creationIndex;Object.defineProperty(this,this._name,{get:function(){return _this.obj.toString()}})}Object.defineProperty(EntityBehavior.prototype,"name",{get:function(){return this._name},enumerable:true,configurable:true});return EntityBehavior}();
...
"initialize",{get:function(){return this._systems._initializeSystems.length},enumerable:true,configurable:true});Object.defineProperty(SystemObserver.prototype,"execute",{get:function(){return this._systems._executeSystems.length},enumerable:true,configurable:true});return SystemObserver}();browser.SystemObserver=SystemObserver;var PoolObserver=function(){function PoolObserver(_pool){this._pool=_pool;this._groups=this._pool._groups}Object.defineProperty(PoolObserver.prototype,"name",{get:function(){return"Pool"},
enumerable:true,configurable:true});Object.defineProperty(PoolObserver.prototype,"Pool",{get:function(){return"Pool "+" ("+this._pool.count+" entities, "+this._pool.reusableEntitiesCount+" reusable, "+Object.keys(this._groups).length+" groups)"},enumerable:true,configurable:true});Object.defineProperty(PoolObserver.prototype,"entities",{get:function(){return this._pool.count},enumerable:true,configurable:true});Object.defineProperty(PoolObserver.prototype,"reusable",{get:function(){return this._pool.reusableEntitiesCount},
enumerable:true,configurable:true});return PoolObserver}();browser.PoolObserver=PoolObserver})(browser=entitas.browser||(entitas.browser={}))})(entitas||(entitas={}));
