...
Matcher.prototype.onEntityAddedOrRemoved=function(){return new TriggerOnEvent(this,GroupEventType.OnEntityAddedOrRemoved)};Matcher.uniqueId=0;return Matcher}();entitas.Matcher=Matcher})(entitas||(entitas={}));var entitas;(function(entitas){var TriggerOnEvent=function(){function TriggerOnEvent(trigger,eventType){this.trigger=trigger;this.eventType=eventType}return TriggerOnEvent}();entitas.TriggerOnEvent=TriggerOnEvent})(entitas||(entitas={}));var entitas;
